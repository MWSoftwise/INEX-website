...
const Hero = () => {
    return(
        <div className="w-full max-w-[600px] lg:max-w-[1400px] h-[90vh] flex flex-col lg:flex-row items-center lg:items-start gap-10 mt-[80px] pt-10 lg:pt-20 px-[15px] lg:px-[50px]">
